...
# Checks GOV-001..006 (13 policies, 5 lifecycles, decisions, templates, registry)
...
.DESCRIPTION
  Kiem tra docs/governance/ co du 13 policies, 5 lifecycles, decisions, templates,
  governance-registry.yaml, INDEX.yaml. Exit 0 = PASS.
#>
param([switch]$Silent)
...
# ---------- GOV-003: 5 lifecycle files ----------
$lifecycles = @('entity-lifecycle.md','workflow-lifecycle.md','plugin-lifecycle.md',
  'artifact-lifecycle.md','specification-lifecycle.md')
