---
name: spec-012-x017-extensions
description: SPEC-012 X017 - Simulation Extensions. 7 extension points, policy, lifecycle.
agent: general
---
...
> **Simulation mo rong nhu the nao ma khong pha vo core?**
...
|----|-----------|-------|----------|
| XEXT-001 | Extension Point | Simulation | High |
| XEXT-002 | Custom Scanner | Simulation | High |
| XEXT-003 | Custom Scoring Rule | Simulation | Medium |
| XEXT-004 | Repair Hook | Policy (S012) | High |
| XEXT-005 | Report Strategy | Simulation | Medium |
| XEXT-006 | Snapshot Serializer | Simulation | Low |
...
Co schema, khong pha invariants (X008), co test, co doc, Simulation Doctor check.

## Tham chieu

- X007 Contracts - SPEC-012
- X008 Invariants - SPEC-012
