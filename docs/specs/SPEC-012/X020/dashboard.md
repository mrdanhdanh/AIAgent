---
name: spec-012-x020-dashboard
description: SPEC-012 X020 - Simulation Dashboard. 6 panels tu S011 metrics.
agent: general
---
...
> **Lam sao quan sat Simulation tren mot man hinh?**
...
SIMULATION_DASHBOARD_OPENED / FILTERED / EXPORTED (S011).

## XDA005 - Tiep nhan

- Neu metric thieu -> loi X011, khong che dashboard.
- Neu score thap -> dan X019 Simulation.
