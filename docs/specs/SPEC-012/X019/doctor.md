---
name: spec-012-x019-doctor
description: SPEC-012 X019 - Simulation Doctor. 10 checks, scoring, report, health gate.
agent: general
---
...
> **Lam sao kiem tra suc khoe SPEC-012 va Simulation?**

## XD001 - Philosophy

- Simulation kiem tra Dinh nghia (docs) + Runtime (thuc thi).
...
Tool: spec012-validator.ps1. Output: reports/.
