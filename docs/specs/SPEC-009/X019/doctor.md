---
name: spec-009-x019-doctor
description: SPEC-009 X019 - Contract Doctor. 10 checks, scoring, report, health gate.
agent: general
---
...
> **Lam sao kiem tra suc khoe SPEC-009 va Contract System?**
...
| XDOC-009 | No Direct Call | X015 metrics | High |
...
Tool: spec009-validator.ps1. Output: reports/.
