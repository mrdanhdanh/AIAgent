---
name: spec-015-x019-doctor
description: SPEC-015 X019 - SDK Doctor. 10 checks, scoring, report, health gate.
agent: general
---
...
> **Lam sao kiem tra suc khoe SPEC-015 va SDK?**

## XD001 - Philosophy

- Doctor kiem tra Dinh nghia (docs) + Runtime (thuc thi).
...
| XDOC-009 | Contract Only | X015 metrics | High |
...
Tool: spec015-validator.ps1. Output: reports/.
