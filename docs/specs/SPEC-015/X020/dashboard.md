---
name: spec-015-x020-dashboard
description: SPEC-015 X020 - SDK Dashboard. 6 panels tu S011 metrics.
agent: general
---
...
> **Lam sao quan sat SDK tren mot man hinh?**

## XDA001 - Philosophy

- Dashboard doc TU metrics/events S011 - khong tao nguon moi.
- Mo panel mo ta mot khia canh SDK.
...
|-------|-------|---------------|
| XPAN-001 | SDK Activity | X011 metrics |
| XPAN-002 | SDK Lifecycle | X009 states |
| XPAN-003 | SDK Failures | X015 metrics |
...
SDK_OPENED / FILTERED / EXPORTED (S011).
