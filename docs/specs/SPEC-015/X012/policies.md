...
> **SDK Engine dung policy nao de bao ve he thong?**

## XP001 - Philosophy

- SDK Engine THUC THI policy - khong dinh nghia lai policy (S012).
- Policy ap dung truoc moi SDK op.
...
- SDK Engine khong quyet dinh chinh sach.
