...
> **Ai quyet dinh ve SDK Engine va thay doi nhu the nao?**

## XG001 - Philosophy

- SDK Engine chiu Authority cua Constitution (SPEC-000).
- Moi quyet dinh ve SDK deu ghi nhan (XDEC).
...
| ID | Issue | Decision |
|----|-------|----------|
| XDEC-001 | SDK co doi he thong that? | Khong - isolated (RULE-007) |
| XDEC-002 | SDK co deterministic? | Co - P013 |
| XDEC-003 | SDK chua Business Data? | Khong - chi metadata |
