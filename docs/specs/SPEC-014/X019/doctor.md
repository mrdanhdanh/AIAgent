---
name: spec-014-x019-doctor
description: SPEC-014 X019 - Dashboard Doctor. 10 checks, scoring, report, Health gate.
agent: general
---
...
> **Lam sao kiem tra suc khoe SPEC-014 va Dashboard?**

## XD001 - Philosophy

- Dashboard kiem tra Dinh nghia (docs) + Runtime (thuc thi).
...
Tool: spec014-validator.ps1. Output: reports/.
