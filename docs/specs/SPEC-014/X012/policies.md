---
name: spec-014-x012-policies
description: SPEC-014 X012 - Dashboard Policies. 10 policies binding S012, isolated.
agent: general
---
...
> **Dashboard Engine dung policy nao de bao ve he thong?**

## XP001 - Philosophy

- Dashboard Engine THUC THI policy - khong dinh nghia lai policy (S012).
- Policy ap dung truoc moi Dashboard op.
...
- Dashboard Engine khong quyet dinh chinh sach.
...
- **Point**: Dashboard Engine, truoc moi op.
