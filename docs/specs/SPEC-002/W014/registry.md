...
- WORKFLOW_REGISTERED · WORKFLOW_UPDATED · WORKFLOW_REGISTRY_DEPRECATED · WORKFLOW_REGISTRY_RETIRED · WORKFLOW_RESOLUTION_FAILED · WORKFLOW_REGISTRY_COMPATIBILITY_FAILED.

> W014 định nghĩa 6 event types WORKFLOW_* — S011 cung cấp event model (fields, correlation_id).
