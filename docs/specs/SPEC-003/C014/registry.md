...
- CAPABILITY_REGISTERED · CAPABILITY_UPDATED · CAPABILITY_REGISTRY_DEPRECATED · CAPABILITY_REGISTRY_RETIRED · CAPABILITY_RESOLUTION_FAILED · CAPABILITY_REGISTRY_COMPATIBILITY_FAILED.

> C014 định nghĩa 6 event types — S011 cung cấp event model (fields, correlation_id).
