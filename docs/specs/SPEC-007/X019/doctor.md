---
name: spec-007-x019-doctor
description: SPEC-007 X019 - Artifact Doctor. 10 checks, scoring, report, health gate.
agent: general
---
...
> **Lam sao kiem tra suc khoe SPEC-007 va Artifact Manager?**
...
| XDOC-009 | No Overwrite | X015 metrics | High |
...
Tool: spec007-validator.ps1. Output: reports/.
