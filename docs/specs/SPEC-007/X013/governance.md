---
name: spec-007-x013-governance
description: SPEC-007 X013 - Artifact Governance. Authority, decisions, lifecycle, matrix.
agent: general
---
...
> **Ai quyet dinh ve Artifact Manager va thay doi nhu the nao?**

## XG001 - Philosophy

- Artifact Manager chiu Authority cua Constitution (SPEC-000).
- Moi quyet dinh ve Artifact deu ghi nhan (XDEC).
...
5. SPEC-007 - dac ta Artifact Manager.
...
| ID | Issue | Decision |
|----|-------|----------|
| XDEC-001 | Artifact co mutable? | Khong - immutable (P010) |
| XDEC-002 | Artifact co overwrite? | Khong - version moi |
| XDEC-003 | Artifact chua Business Data? | Khong - chi metadata |
| XDEC-004 | Archive che do? | Theo retention (S012) |
...
SPEC007_FROZEN / UNFROZEN / VERSIONED / DECISION_MADE / DECISION_OVERRIDDEN (S011).

## XG007 - Binding Enforcement

RULE-005 (immutable), RULE-014 (observability), XPOL-001..010.
