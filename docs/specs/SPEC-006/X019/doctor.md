---
name: spec-006-x019-doctor
description: SPEC-006 X019 - Context Doctor. 10 checks, scoring, report, health gate.
agent: general
---
...
> **Lam sao kiem tra suc khoe SPEC-006 va Context Engine?**
...
| XDOC-009 | No Leak | X015 metrics | High |
...
Tool: spec006-validator.ps1. Output: reports/.
