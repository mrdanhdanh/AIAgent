---
name: spec-006-x018-evolution
description: SPEC-006 X018 - Context Evolution. Versioning, deprecation, migration.
agent: general
---
...
> **SPEC-006 phat trien qua cac version nhu the nao?**
...
Backward: giu Context contract cu.
...
Runtime Context: KHONG migrate - transient, tao moi.
