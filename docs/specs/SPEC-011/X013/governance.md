---
name: spec-011-x013-governance
description: SPEC-011 X013 - Doctor Governance. Authority, decisions, lifecycle, matrix.
agent: general
---
...
> **Ai quyet dinh ve Doctor va thay doi nhu the nao?**

## XG001 - Philosophy

- Doctor chiu Authority cua Constitution (SPEC-000).
- Moi quyet dinh ve Doctor deu ghi nhan (XDEC).
...
| ID | Issue | Decision |
|----|-------|----------|
| XDEC-001 | Doctor co sua core? | Khong - non-invasive (P015) |
| XDEC-002 | Doctor co tu quyet dinh? | Khong - chi de xuat (S013) |
| XDEC-003 | Doctor chua Business Data? | Khong - chi metadata |
| XDEC-004 | Repair pham vi? | doc-only (P015) |
...
SPEC011_FROZEN / UNFROZEN / VERSIONED / DECISION_MADE / DECISION_OVERRIDDEN (S011).
