---
name: spec-016-x019-doctor
description: SPEC-016 X019 - CLI Doctor. 10 checks, scoring, report, health gate.
agent: general
---
...
> **Lam sao kiem tra suc khoe SPEC-016 va CLI?**
...
Tool: spec016-validator.ps1. Output: reports/.
