---
name: spec-008-x019-doctor
description: SPEC-008 X019 - Event Doctor. 10 checks, scoring, report, health gate.
agent: general
---
...
> **Lam sao kiem tra suc khoe SPEC-008 va Event Bus?**
...
| XDOC-009 | No Mutate | X015 metrics | High |
...
Tool: spec008-validator.ps1. Output: reports/.
